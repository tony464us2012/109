    ...
    return loading ? <Loader /> : error ? <Message variant='danger'>{error}</Message> : (
        <Flex style={{backgroundColor:'bache', justifyContent: 'space-around', padding:'10% 0'}} margin='6rem 0' wrap='wrap'>
            <Box minWidth='300px' maxW='700px'>
              <Image
              src="https://images2.imgbox.com/d5/76/vFnR7Aan_o.png"
              alt='Burger'
              />
            </Box>
            <Box className='frontpage-text' style={{padding: '0 1.5rem', display: 'flex', flexDirection:'column',  justifyContent: 'center', marginTop:'2rem'}}>
